    ...
    <div className="space-y-16 pb-24">
      ...
      >
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 lg:items-end">
          ...
          <div className="space-y-6 relative flex flex-col text-center md:text-left">
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-10 backdrop-blur-sm shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
        ...
        <div className="mt-16 space-y-6">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group relative rounded-xl bg-[#1a1a1a] border border-white/10 p-3 shadow-lg transition-all duration-300 hover:scale-105 hover:border-[#FF6A00]/40 hover:shadow-[0_0_25px_rgba(255,106,0,0.3)]"
            >
              <img
                src="/oscp.png"
      ...
      >
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-white/70 mt-6">
            A snapshot of the technologies and offensive techniques I use across real-world assessments and red-team workflows.
          </p>
        </div>

        <div className="grid gap-6 md:grid-cols-3">
          {/* Offensive Techniques Card - Red Theme */}
          <div className="rounded-2xl border border-[#8B0000]/30 bg-gradient-to-br from-[#8B0000]/10 via-[#1a0a0a] to-[#8B0000]/5 p-6 shadow-lg shadow-[#8B0000]/20 backdrop-blur-sm">
          ...
          <div className="rounded-2xl border border-[#FF6A00]/30 bg-gradient-to-br from-[#FF6A00]/10 via-[#1a0a0a] to-[#FF6A00]/5 p-6 shadow-lg shadow-[#FF6A00]/20 backdrop-blur-sm">
            <div className="flex items-center gap-3 mb-6">
          ...
          <div className="rounded-2xl border border-[#5B21B6]/25 bg-gradient-to-br from-[#5B21B6]/8 via-[#1a0a0a] to-[#4C1D95]/4 p-6 shadow-lg shadow-[#5B21B6]/15 backdrop-blur-sm">
            <div className="flex items-center gap-3 mb-6">
        ...
        <p className="text-center text-white/60 text-sm mt-10">
          For full skill list download my resume
        </p>
      </section>

      <section
        id="experience"
        className="scroll-mt-32 rounded-3xl border border-white/5 bg-[#070707] p-8 text-white/80"
      >
        <h2 className="text-2xl font-semibold text-white">Experience</h2>
        <p className="mt-4 text-sm text-white/60">
          Future timeline will drop here. For now this paragraph ensures the
          section exists so the anchor can be tested.
        </p>
      </section>
      ...
      >
        ...
        <p className="mt-4 text-sm text-white/60">
          Placeholder cards incoming—this is just spacing for the nav jump.
        </p>
      </section>
      ...
      >
        ...
        <p className="mt-4 text-sm text-white/60">
          Medium write-ups will surface here soon. Anchor-ready content for now.
        </p>
      </section>
      ...
      >
        ...
        <p className="mt-4 text-sm text-white/60">
          Socials, phone, and email will land in this block shortly. Use the nav
          to confirm smooth scrolling hits this exact spot.
        </p>
      </section>
    </div>
  );
